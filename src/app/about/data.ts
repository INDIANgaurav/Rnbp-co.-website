export const team = [
  {
    ...
    phone: "+91-981 858 8733",
    email: "amit.garg@rnbp.in",
    experience: "20+ years",
    expertise: "Ind AS/IFRS Implementation & Financial Reporting Software",
    image: "/Amit2.jpg",
    description:
  ...
  },
  {
    ...
    phone: "+91-991 197 7449",
    email: "Saurabh.Aggarwal@rnbp.in",
    experience: "16+ years",
    expertise: "Product Strategy & IFRS/Ind AS",
    image: "/Saurabh.jpeg",
    description:
  ...
  },
  {
    ...
    phone: "+91-956 028 3131",
    email: "Gaurav.malik@rnbp.in",
    experience: "10+ years",
    expertise: "FP&A & Data Analytics",
    image: "/gaurav.jpg",
    description:
      "Gaurav Malik is a Chartered Accountant by profession and carries over 10 years of experience in Financial Planning & Analysis (FP&A) and data analytics at leading organizations including EY, Vedanta Limited, Kotak Mahindra Bank Limited, and other global MNCs. He brings proven expertise to FinSensor's financial statements consolidation platform. He has spearheaded budgeting and forecasting for complex, multi-entity groups; conducted margin and profitability analysis across consolidated structures; and built advanced financial models. Key contributions include internal management reporting automation and external deliverables like investor presentations, press releases, and annual reports. At FinSensor, Gaurav empowers clients to transform fragmented financial data into actionable insights, driving efficiency in group-wide reporting and strategic decision-making.",
  },
  {
    name: "Abhinav Aggarwal",
    designation: "Technology Lead",
    phone: "+91-981 192 1063",
    email: "abhinav.aggarwal@rnbp.in",
    experience: "10+ years",
    expertise: "Business Transformation & Automation",
    image: "/Abhinav.jpg",
    description:
      "Abhinav Aggarwal is a Chartered Accountant by profession with more than 10 years of experience in Financial Planning & Analysis (FP&A), business transformation, and automation implementation at organizations like Infosys Limited, Sumitomo, and other global MNCs. Abhinav excels in driving consolidation efficiency at FinSensor. He has led finance transformation projects, ERP and FP&A tool implementations, process improvements, and business analytics initiatives—focusing on streamlining multi-entity consolidations, intercompany reconciliations, and real-time group reporting. Proficient in scalable analytics, delivering measurable ROI through automation and data-driven insights. At FinSensor, Abhinav helps clients accelerate their finance digital journey, transforming complex consolidations into agile, compliant operations.",
  },
  {
    name: "Rakesh Kumar",
    designation: "FCA, ACS, M.Com",
    phone: "+91-971 730 3394",
    email: "rakesh.kumar@rnbp.in",
    experience: "10+ years",
    expertise: "Accounting & Secretarial",
    image: "/Rakesh.jpeg",
    description:
      "Specializes in Accounting, Reporting and Secretarial Records. Rakesh is a Chartered Accountant and Company Secretary with 10+ years of experience. His core expertise includes representation before NCLT, formation of Companies, annual filing, XBRL, Statutory Due Diligence Reviews, SEBI Compliance, and ROC Filing.",
  },
];
